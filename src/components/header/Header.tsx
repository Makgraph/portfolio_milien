      ...
      <nav className="relative p-4 flex flex-col md:flex-row justify-between items-center">
        <div className="flex w-full justify-between">
          ...
          <div className="md:hidden flex items-center">
            <List
              ...
              weight="bold"
              // color="#2F218F"
              className="text-primary-default dark:text-primary-onContainerD cursor-pointer"
        ...
        <ul
          className={`fixed inset-0 bg-background p-6 flex flex-col items-center gap-4 text-sm font-serif text-black md:flex md:flex-row md:relative md:bg-transparent md:p-0 md:gap-8 ${
            menuOpen
              ? "flex top-[45%] shadow-inner dark:bg-primary-containerD rounded-t-full rounded-b-none"
              : "hidden"
          }`}
        >
        ...
        <X
          size={24}
          weight="bold"
          className={`absolute top-4 right-4 text-onSurfaceL dark:text-primary-onContainerD cursor-pointer md:hidden ${
