...
const Data: React.FC = () => {
  return (
    <div className="mt-8 md:mt-0 flex flex-col gap-4">
      <div className="flex">
        {/* <h1 className="font-semibold hidden md:flex">Makenson Milien</h1> */}
        <h3 className="font-semibold sm:text-[32px] text-secondary-onContainerL dark:text-secondary-onContainerD ">
          Makenson Milien
        </h3>
        <svg
          viewBox="0 0 48 48"
          ...
          className="md:w-[38px] md:h-[38px] w-[34px] h-[34px]"
        >
          <path
      ...
      <h4 className="text-secondary-onContainerL dark:text-secondary-onContainerD home__subtitle">
        Fullstack Developer - UX/UI Designer - Graphist
      </h4>

      <p className="relative text-secondary-onContainerL dark:text-secondary-onContainerD home__description">
        I'm a Full-Stack Developer, UX/UI Designer, and Graphic Artist,
        seamlessly blending coding expertise with creative design to deliver
        visually compelling and user-focused digital solutions
      </p>

      <a
        href="#contact"
        className="inline-flex justify-center w-[45%] items-center bg-secondary-onContainerL text-onPrimary-light py-5 px-8 rounded-[1rem] font-medium hover:bg-secondary-onContainerL/80 button botton--flex"
      >
        Say Hello
        <svg
